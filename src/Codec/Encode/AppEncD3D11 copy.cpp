...
// void Encode(ID3D11Device *pDevice, ID3D11DeviceContext *pContext, int nWidth, int nHeight,
// 			NvEncoderInitParam encodeCLIOptions, ID3D11Texture2D *pTexSysMem,
// 			std::ofstream &fpOut)
// {
// 	//? NV_ENC_BUFFER_FORMAT_ARGB is good since its in reverse order of BGRA
// 	NvEncoderD3D11 enc(pDevice, nWidth, nHeight, NV_ENC_BUFFER_FORMAT_ARGB);
...
// 	// set color data to full white
// 	// std::fill(colorData.begin(), colorData.end(), 255);

// 	// ReadInputFrameFromVector(encoderInputFrame, colorData, pContext, pTexSysMem, nHeight, nWidth);
