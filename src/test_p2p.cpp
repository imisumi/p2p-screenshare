...
int main(int argc, const char **argv)
{
	...
	// std::unique_ptr<TrivialSignalingClient> pSignaling = TrivialSignalingClient::CreateTrivialSignalingClient(pszTrivialSignalingService, SteamNetworkingSockets(), errMsg);
